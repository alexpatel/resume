...
\section{COMPUTER SKILLS}
    {\sl Languages:} Fluent: Python, C, R, SQL; Beginner: Ruby, Javascript, Java. \\
...
\section{WORK EXPERIENCE}
    ...
    \begin{itemize}  \itemsep -2.5pt
        \item Acted as technical lead for development of real-time bidding
            ...
            low-latency ($<$100ms) networking server in Python.  Oorganized
...
\section{TEACHING}
    ...
    \textbf{Harvard Mathematics Department}
    ...
    \textbf{Harvard Computer Science Department}
